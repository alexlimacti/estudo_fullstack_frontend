...
export const CONFIRM_REGISTER_URL =
  BASE_URL + "api/public/regitrationConfirm/users";
export const RESEND_REGISTER_TOKEN_URL =
  BASE_URL + "api/public/resendRegistrationToken/users";
